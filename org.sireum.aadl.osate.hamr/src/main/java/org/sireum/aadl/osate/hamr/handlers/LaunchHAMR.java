...
//get plugins from Eclipse extension points
							IS<Z, org.sireum.hamr.codegen.common.plugin.Plugin> plugins = VisitorUtil
									.toISZ(HAMRPluginUtil.getHamrPlugins(si)
...
//							      new BlessDatatypeProvider()
							...
							mplugins = mplugins.$plus$plus(org.sireum.hamr.arsit.plugin.ArsitPlugin.defaultPlugins());
