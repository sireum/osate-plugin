...
public class ApiUtil {
	 ...
	 * command line whereas codegen's OSATE plugin calls
	 * org.sireum.cli.HAMR.codeGenR. This can cause an issue if the master branch
	 * version of org.sireum.cli.HAMR.codeGenR is modified but an updated codegen
	 * plugin is not also released. HAMR codegen regression tests use Phantom CLI so
	 * this method is now called from phantom (and codegen's plugin) to catch this
	 * issue.
	 * 
	...
	public static boolean hamrCliApiCompatible(PrintStream out) {
		...
		// Paste the following into a java program if you want to ensure the known keys
		// match.
		// To regenerate this, run '$SIREUM_HOME/hamr/codegen/build.cmd regen-cli'.
		// If this does fail then the CLI arguments being constructed for codegen will
		// need
		...
		org.sireum.IS<org.sireum.Z, org.sireum.String> knownKeys = org.sireum.IS$.MODULE$
				...
				.$colon$plus(new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_scheduling()))
				.$colon$plus(
						new org.sireum.String(org.sireum.hamr.codegen.LongKeys.CAmkES_Microkit_verusAttributeSyntax()))
