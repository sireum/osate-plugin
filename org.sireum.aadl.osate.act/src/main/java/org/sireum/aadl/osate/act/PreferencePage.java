...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		...
		addField(new BooleanFieldEditor(PreferenceValues.ACT_SERIALIZE_OPT,
				"Serialize AIR to JSON (non-compact) when generating CAmkES", actTab));

		addField(new StringFieldEditor(PreferenceValues.ACT_OUTPUT_FOLDER_OPT, "Output folder", actTab));
	}
